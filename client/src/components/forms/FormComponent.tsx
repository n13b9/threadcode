...
const FormComponent = () => {
  ...
  const joinRoom = (e: FormEvent<HTMLFormElement>) => {
    ...
    console.log(currentUser.roomId, "herer here");
  };

  useEffect(() => {
    if (currentUser.roomId && currentUser.roomId.length > 0) return;
  ...
  }, [location.state?.roomId, setCurrentUser]);
  ...
  useEffect(() => {
    ...
    if (status === USER_STATUS.JOINED && !isRedirect) {
      ...
      console.log(currentUser.roomId, isRedirect, "herer here");
